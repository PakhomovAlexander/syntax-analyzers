...
%%% Изображения %%%
\graphicspath{{images/}{Diploma/images/}}         % Пути к изображениям
...
\setbeforesecskip{12pt}% ГОСТ может отделять хоть 10-ю интервалами, а вот кафедра МОиАИС ВГУ отделяет 12 и 6 пт.
\setaftersecskip{6pt}
...
% Не испольщовать отступы в align окружении
