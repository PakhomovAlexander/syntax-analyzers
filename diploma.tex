...
\include{Diploma/title}           % Титульный лист
\include{Diploma/contents}        % Оглавление
\include{Diploma/introduction}    % Введение
\include{Diploma/part1}			  % Глава 1
\include{Diploma/part2}			  % Глава 2
\include{Diploma/taskdefinition}  % Постановка задачи
\include{Diploma/analyze}         % Анализ задачи
\include{Diploma/conclusion}      % Заключение
