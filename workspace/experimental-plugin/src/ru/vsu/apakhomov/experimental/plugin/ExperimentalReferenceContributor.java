...
public class ExperimentalReferenceContributor extends PsiReferenceContributor {
    @Override
                    ...
                    public PsiReference[] getReferencesByElement(@NotNull PsiElement element,
                        ...
                        if (value != null && value.startsWith(keyword + ":")) {
                            return new PsiReference[]{
                                    new ExperimentalReference(element, new TextRange(keyword.length() + 2, value.length() + 1))};
                        }
